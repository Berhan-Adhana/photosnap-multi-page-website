...
const PricePlan = ({ plan, isBgBlack, isMonthly = false }) => {
  return (
    <article
      className={`relative pt-[56px] hover:shadow-planShadow pb-10 flex flex-col items-center md:items-start lg:items-center  px-10 w-[318px] lg:w-[350px]  md:w-full shadow-sm transition-all duration-500 ${
        isBgBlack
